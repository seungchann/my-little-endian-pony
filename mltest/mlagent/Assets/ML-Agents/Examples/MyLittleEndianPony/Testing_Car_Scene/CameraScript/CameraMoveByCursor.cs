...
public class CameraMoveByCursor : MonoBehaviour
{
    [Range(0.0f, 100.0f)]
    ...
    private void GetParameters()
    {
        ...
        MainCamera[mainIndex].farClipPlane = cameraArray[index].farClipPlane;
        MainCamera[mainIndex].nearClipPlane = cameraArray[index].nearClipPlane;
